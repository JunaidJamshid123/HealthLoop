package com.junaidjamshid.healthloop.presentation.profile
...
import com.junaidjamshid.healthloop.data.local.util.ImageUtils
            ...
            is ProfileEvent.UpdateSetting -> {
                ...
                _uiState.update {
                    when (event.key) {
                        ...
                        "reminders" -> {
                            val notifManager = com.junaidjamshid.healthloop.util.NotificationManager(appContext)
                            if (event.value) {
