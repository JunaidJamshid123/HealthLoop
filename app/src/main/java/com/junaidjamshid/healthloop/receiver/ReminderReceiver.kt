...
import com.junaidjamshid.healthloop.alarm.AlarmActivity
import com.junaidjamshid.healthloop.alarm.AlarmService
...
class ReminderReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent?) {
        ...
        try {
            ...
            val notificationManager = com.junaidjamshid.healthloop.util.NotificationManager(context)
